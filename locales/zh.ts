...
export const zh: Dict = {
  ...
  model: {
    back: "← 返回",
    viewerLbl: "3D查看区域",
    viewerNote: "该模型正在制作中。上线后即可在此旋转、拆解并学习。",
    startLearn: "开始学习",
    overview: "概述",
    specs: "主要规格",
  },
  ...
  category: { suffix: "模拟器", guide: "推荐顺序" },
  cat: {
    semiconductor: "半导体",
    space: "航天",
    automotive: "汽车",
  ...
  pages: {
    about: {
      ...
      sections: [
        ...
        {
          heading: "为谁而做",
          body: "正在探索方向与技术领域的学生，<br>想快速了解相邻领域结构的工程师，<br>以及对新闻中前沿技术内部感到好奇的每个人。<br><br>无需专业背景——所有说明都从通俗语言开始。",
        },
        {
          heading: "有何不同",
    ...
    learn: {
      ...
      sections: [
        ...
        {
          heading: "从通俗语言到精确数据",
          body: "说明从比喻和通俗语言开始，再进入真实术语与数据——先说“摊开热量的金属盖”，再给出准确的部件名称、材质与尺寸。觉得吃力时，只读摘要也能跟上思路。",
        },
        {
          heading: "各领域的推荐顺序",
          body: "每个领域都有最容易理解其模型的顺序。各领域页面顶部会显示“推荐顺序”——不知从何开始时，跟着它走即可。",
        },
      ],
    },
    intent: {
