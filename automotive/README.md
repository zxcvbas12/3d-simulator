...
| `drive-motor/` 구동 모터 | ⏳ 준비 중 | 전기를 **어떻게 회전력으로 바꾸는가** | 동심(껍질) 예정 |
| `combustion-engine/` 내연기관 엔진 | ⏳ 준비 중 | 연료를 **어떻게 동력으로 바꾸는가** | 혼합 예정 |

EV 배터리 → 구동 모터로 이어 보면 "전기 동력계(저장 → 구동)" 한 쌍이 됩니다. 내연기관은 그 대비로 둡니다.
